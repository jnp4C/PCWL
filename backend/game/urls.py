...
urlpatterns = [
    ...
    path("auth/verify-email/<str:uidb64>/<str:token>/", EmailVerificationView.as_view(), name="email-verify"),
    ...
    path("session/login/2fa/", SessionLoginTwoFactorView.as_view(), name="session-login-2fa"),
