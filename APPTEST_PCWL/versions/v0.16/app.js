...
const quickCheckInButton = document.getElementById('quick-checkin-button');
...
function updateRecentCheckinTags(history) {
  ...
  if (first) {
    recentCheckinTagPrimary.textContent = formatRecentCheckinTag(first);
  } else {
    recentCheckinTagPrimary.textContent = 'No check-ins yet';
  }
  recentCheckinTagPrimary.classList.remove('empty');

  if (second) {
    recentCheckinTagSecondary.textContent = formatRecentCheckinTag(second);
    recentCheckinTagSecondary.classList.remove('empty');
  } else {
    recentCheckinTagSecondary.textContent = '';
    recentCheckinTagSecondary.classList.add('empty');
  }
}
...
if (quickCheckInButton) {
  quickCheckInButton.addEventListener('click', () => {
    handleCheckIn();
  });
}
